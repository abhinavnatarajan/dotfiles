	...
	config = function()
		...
		wk.register({ 
			["<leader>k"] = { 
				...
				["<leader>kf"] = { [[<CMD>SessionManager load_session<CR>]], icons.ui.FindFolder .. " Load workspace" },
				["<leader>kd"] = { [[<CMD>SessionManager >]], desc = icons.ui.Trash .. " Delete workspace" },
				["<leader>kw"] = { "<CMD>SessionManager save_current_session<CR>", icons.ui.Save .. " Save current workspace" },
				["<leader>kr"] = { [[<CMD>SessionManager load_last_session<CR>]],icons.ui.History .. " Load last session" },
			}
		})
